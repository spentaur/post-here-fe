  ...
  <div id="container" class="bg-white pt-3 pb-16 px-4 overflow-hidden sm:px-6">
    <div class="relative max-w-2xl mx-auto">
      ...
      <div class="p-4 text-lg sm:text-center text-left text-gray-500">
        ...
        The model was converted to ONNX and uses the serverless framework to
        deploy to AWS and onnxruntime to run inferences. Please refer to the
        following repos and blog posts below for more information, and code
        examples.
      </div>
